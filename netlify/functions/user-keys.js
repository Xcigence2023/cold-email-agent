/**
 * user-keys.js - Optimized with caching and input validation
 * - Auth cached 5 min
...
exports.handler = async function(event) {
  ...
  if (event.httpMethod === 'GET') {
    ...
    const r = await fetch(`${SB}/rest/v1/user_api_keys?user_id=eq.${user.id}&select=anthropic_key,sendgrid_key,sender_name,sender_email,sender_title,sender_company`, {
